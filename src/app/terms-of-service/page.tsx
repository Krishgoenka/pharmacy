    ...
    <div className="container mx-auto px-4 md:px-6 py-12 md:py-16 animate-fade-in">
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4 text-foreground leading-relaxed">
          ...
          <p>Mahindra Pharmacy provides pharmaceutical services, including the sale of prescription and over-the-counter medications, home delivery, medical tests, and doctor consultations. All services are subject to availability and applicable laws and regulations.</p>
          ...
          <p>The service and its original content, features, and functionality are and will remain the exclusive property of Mahindra Pharmacy and its licensors. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Mahindra Pharmacy.</p>

          <h2 className="font-headline text-2xl mt-6">6. Limitation of Liability</h2>
          <p>In no event shall Mahindra Pharmacy, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the service.</p>
          ...
          <p>If you have any questions about these Terms, please contact us at [Your Pharmacy Email] or [Your Pharmacy Phone Number].</p>
        </CardContent>
      </Card>
    </div>
  );
